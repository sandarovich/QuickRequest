...
passport.use(new passportlocal.Strategy(function(username, password, done) {
    ...
    process.nextTick(function () {
      ...
      // Find the user by user name.  If there is no user with the given
...
switch (code) {
    ...
    break
    case '4':
     result = 'Адіністративна робота.PO' + '\n'
